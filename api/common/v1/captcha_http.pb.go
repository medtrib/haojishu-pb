...
func RegisterCaptchaHTTPServer(s *http.Server, srv CaptchaHTTPServer) {
	r := s.Route("/")
	r.GET("/common/captcha/v1/getCaptcha", _Captcha_GetCaptcha0_HTTP_Handler(srv))
	r.GET("/common/captcha/v1/verifyCaptcha", _Captcha_VerifyCaptcha0_HTTP_Handler(srv))
}
