...
const (
	...
	Role_GetRole_FullMethodName    = "/api.role.v1.Role/GetRole"
	Role_ListRole_FullMethodName   = "/api.role.v1.Role/ListRole"
)
...
type RoleClient interface {
	...
	// 删除角色
	DeleteRole(ctx context.Context, in *DeleteRoleRequest, opts ...grpc.CallOption) (*RoleReply, error)
	// 获取角色
...
func (c *roleClient) UpdateRole(ctx context.Context, in *UpdateRoleRequest, opts ...grpc.CallOption) (*RoleReply, error) {
	out := new(RoleReply)
...
func (c *roleClient) DeleteRole(ctx context.Context, in *DeleteRoleRequest, opts ...grpc.CallOption) (*RoleReply, error) {
	out := new(RoleReply)
...
func (UnimplementedRoleServer) UpdateRole(context.Context, *UpdateRoleRequest) (*RoleReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateRole not implemented")
}
func (UnimplementedRoleServer) DeleteRole(context.Context, *DeleteRoleRequest) (*RoleReply, error) {
