...
const (
	Menu_CreateMenu_FullMethodName   = "/api.role.v1.Menu/CreateMenu"
	Menu_UpdateMenu_FullMethodName   = "/api.role.v1.Menu/UpdateMenu"
	Menu_DeleteMenu_FullMethodName   = "/api.role.v1.Menu/DeleteMenu"
	Menu_GetMenu_FullMethodName      = "/api.role.v1.Menu/GetMenu"
	Menu_ListMenu_FullMethodName     = "/api.role.v1.Menu/ListMenu"
	Menu_ListMenuTree_FullMethodName = "/api.role.v1.Menu/ListMenuTree"
)
...
type MenuClient interface {
	// CreateMenu 创建菜单
	CreateMenu(ctx context.Context, in *CreateMenuRequest, opts ...grpc.CallOption) (*MenuReply, error)
	// UpdateMenu 编辑菜单
	UpdateMenu(ctx context.Context, in *UpdateMenuRequest, opts ...grpc.CallOption) (*MenuReply, error)
	// DeleteMenu 删除菜单
	DeleteMenu(ctx context.Context, in *DeleteMenuRequest, opts ...grpc.CallOption) (*MenuReply, error)
	// GetMenu 查询单挑菜单信息
	GetMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*GetMenuReply, error)
	// ListMenu 获取菜单列表
	ListMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*ListMenuReply, error)
	// ListMenuTree 获取树形列表
	ListMenuTree(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*ListMenuReply, error)
}
...
func (c *menuClient) CreateMenu(ctx context.Context, in *CreateMenuRequest, opts ...grpc.CallOption) (*MenuReply, error) {
	out := new(MenuReply)
...
func (c *menuClient) UpdateMenu(ctx context.Context, in *UpdateMenuRequest, opts ...grpc.CallOption) (*MenuReply, error) {
	out := new(MenuReply)
...
func (c *menuClient) DeleteMenu(ctx context.Context, in *DeleteMenuRequest, opts ...grpc.CallOption) (*MenuReply, error) {
	out := new(MenuReply)
...
func (c *menuClient) ListMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*ListMenuReply, error) {
...
func (c *menuClient) ListMenuTree(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*ListMenuReply, error) {
	out := new(ListMenuReply)
	err := c.cc.Invoke(ctx, Menu_ListMenuTree_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMenuServer) CreateMenu(context.Context, *CreateMenuRequest) (*MenuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMenu not implemented")
}
func (UnimplementedMenuServer) UpdateMenu(context.Context, *UpdateMenuRequest) (*MenuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateMenu not implemented")
}
func (UnimplementedMenuServer) DeleteMenu(context.Context, *DeleteMenuRequest) (*MenuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteMenu not implemented")
}
func (UnimplementedMenuServer) GetMenu(context.Context, *GetMenuRequest) (*GetMenuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMenu not implemented")
}
func (UnimplementedMenuServer) ListMenu(context.Context, *GetMenuRequest) (*ListMenuReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListMenu not implemented")
}
func (UnimplementedMenuServer) ListMenuTree(context.Context, *GetMenuRequest) (*ListMenuReply, error) {
...
func _Menu_ListMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServer).ListMenu(ctx, req.(*GetMenuRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Menu_ListMenuTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMenuRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MenuServer).ListMenuTree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Menu_ListMenuTree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServer).ListMenuTree(ctx, req.(*GetMenuRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Menu_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Menu_ListMenuTree_Handler,
		},
	},
